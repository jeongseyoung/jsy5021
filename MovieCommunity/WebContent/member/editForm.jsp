...
<body>
	...
	<div align="center">
	<h3> 내 정보수정</h3> <br>
	<form name="f" action="<%=request.getContextPath()%>/member/edit.do" method="post">
	<div class="inputbox">			
				<input type="text" name="id" value="${m.id }" readonly><br><br>	
				<input type="password" name="pwd" class="focus" value="${m.pwd }"><br><br>
				<input type="text" name="email" value="${m.email }"><br><br>		
			</div>
