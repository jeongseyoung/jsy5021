...
<body>
	...
	<div align="center">
	<h3>로그인</h3><br>
	<form name="f" action="<%=request.getContextPath()%>/member/login.do" method="post">		
		<div class="inputbox">			
			<input type="text" name="id" placeholder="아이디를 입력하세요." class="userid"><br>
			<span class="blankid">입력된 값이 없습니다.</span><br><br>			
			<input type="password" name="pwd" placeholder="비밀번호를 입력하세요." class="userpwd"><br>
			<span class="blankpass">입력된 값이 없습니다.</span>	<br><br>			
		</div>			
		<a href="javascript: resetForm()"><img src='<%=request.getContextPath() %>/data/reinput.png' width='150' height='50' hspace='2' border='0'></a> <br><br>
		<a href="javascript: submitForm()"><img src='<%=request.getContextPath() %>/data/loginmem.png' width='150' height='50' hspace='2' border='0'></a> <br><br>
		<a href="<%=request.getContextPath() %>/member/form.do"><img src='<%=request.getContextPath() %>/data/insert.png' width='150' height='50' hspace='2' border='0'></a>	<br><br>
	</form>	
	</div>
