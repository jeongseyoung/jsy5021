...
<form name="f" action="<%=request.getContextPath() %>/Image/insert.do" method="post" enctype="multipart/form-data">
	<table border="0" class="style4">

				<tr class="inputbox">
				<th width="150"> 게시자 </th>
				<td width="500"> <input type="text" name="id" size=80 value="${id }" size="80" placeholder="게시자명을 입력하세요"></td>
				</tr>
