...
<body>
	...
	<div class="tableClass">
		...
		<table border="0" class="style4">
			...
			<c:forEach var="b" items="${qas }">
				<tr>
					<td width="80" align="center">${b.num }</td>				
					<td width="250" align="center">
						<a href="<%=request.getContextPath() %>/qa/read.do?num=${b.num }" style="text-decoration:none; color:black; font-weight: bold">${b.title }</a>				
					</td>
					<td width="100" align="center">${b.writer }</td>
					<td width="100" align="center">${b.qa_date }</td>
				</tr>
			</c:forEach>
		</table>
		</div>
	...
	<div align="right" style="margin-right: 100px;">		
		<a href="<%=request.getContextPath() %>/qa/form.jsp"><img src='<%=request.getContextPath() %>/data/writeboard.png' width='90' height='35' hspace='2' border='0'></a>
	</div>
