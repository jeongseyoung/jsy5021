...
<script type="text/javascript">
	function submitForm(){
		alert("수정을 완료하시겠습니까?")
		document.f.action+="/movieInfo/movieedit.do?num=${m.num }";
		document.f.submit();
	}
	...
	<div align="center">
		...
		<form name="f" action="<%=request.getContextPath()%>/" method="post">
			<table border="0" class="style4">
				...
				<td width="500"> <input type="text" name="writer" size=80 value="${m.title }"></td>
			</tr>
			<tr>
				<th width="150"> 감독 </th>
				<td width="500"> <input type="password" name="pwd" size=80 value="${m.director }"></td>
			</tr>
			<tr>
				<th width="150"> 개봉일 </th>
				<td width="500"> <input type="text" name="title" size=80 value="${m.release_date }"></td>
			</tr>
			<tr>
				<th width="150"> 동영상 </th>
				<td width="500"> <input type="text" name="director" size=80 value="${m.video }"></td>
			</tr>			
			<tr>
				<th width="150"> 내용 </th>
				<td width="500"> <textarea rows="20" cols="82" name="content"> ${m.content }</textarea></td>
			</tr>
			<tr>
