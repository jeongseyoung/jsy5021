...
<script type="text/javascript">
	function a(x,pw,q){
		...
		if(x==1){			
			document.f.action+="/board/editForm.do?num=${articles.num }";
		}else if(x==2){
			alert("정말 삭제하시겠습니까??");
			document.f.action+="/board/boarddel.do?num=${articles.num }";
		}
		document.f.submit();
	}
</script>
	...
	<form name="f" action="<%=request.getContextPath() %>/" method="post">
		<table border="0" class="style4">
			<tr>
				...
				<td width="500"> ${articles.num }</td>				
			</tr>
			<tr>
				<th width="150"> 작성자 </th> 
				<td width="500"> ${articles.writer }</td>				
			</tr>
			<tr>
				<th width="150"> 제목 </th> 
				<td width="500"> ${articles.title }</td>				
			</tr>
			<tr>
				<th width="150"> 작성일 </th> 
				<td width="500"> ${articles.board_date}</td>		
			</tr>	
			
			<tr class="inputbox">
				<th width="150"> 내용 </th>
				<td width="500"> ${articles.content }</td>
			</tr>
			<tr>
				<td colspan="2" align="center" > 				
					<a href="javascript: a(1, ${articles.pwd}, ${articles.num})"><img src='<%=request.getContextPath() %>/data/editboard.png' width='80' height='30' hspace='2' border='0'></a> 
					<a href="javascript: a(2, ${articles.pwd}, ${articles.num})"><img src='<%=request.getContextPath() %>/data/delboard.png' width='80' height='30' hspace='2' border='0'></a> 
				</td>
			</tr>
		</table>	
		<table border="0" class="style4">
			...
			<c:forEach var="r" items="${rep }">
				<tr>					
					...
					<td width="150" align="center" style="font-weight: bold; font-size: 12px;"> ${r.rep_date }</td>				
				</tr>
			</c:forEach>
		</table>
		</form>	
		<form name="r" action="<%=request.getContextPath() %>/board/writeRep.do?num=${articles.num }" method="post">
			<table border="0" class="style4">
				<tr class="inputbox">										
