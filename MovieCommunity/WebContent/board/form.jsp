...
<body>
	...
	<div align="center">
	<h3>게시글 작성</h3>
	<form name="f" action="<%=request.getContextPath() %>/board/write.do" method="post">		
		<table border="0" class="style4">
			<tr class="inputbox">
				<th width="150"> 작성자 </th>
				<td width="500"> <input type="text" name="writer" size=80 value="${id }" placeholder="아이디를 입력하세요"></td>
			</tr>
			<tr class="inputbox">
				<th width="150"> 제목 </th>
				<td width="500"> <input type="text" name="title" size=80 placeholder="제목을 입력하세요."></td>
			</tr>
			<tr class="inputbox">
				<th width="150"> 글 비밀번호 </th>
				<td width="500"> <input type="password" name="pwd" size=80 placeholder="비밀번호를 입력하세요."></td>
			</tr>
			<tr class="inputbox">
				<th width="150"> 내용 </th>
				<td width="500"> <textarea rows="20" cols="82" name="content" class="textbox"></textarea></td>
			</tr>
			<tr>
