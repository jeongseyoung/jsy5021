...
<script type="text/javascript">
	function submitForm(){
		alert("수정을 완료하시겠습니까?")
		document.f.action+="/board/boardedit.do?num=${m.num }";
		document.f.submit();
	}
	...
	<div align="center">
		...
		<form name="f" action="<%=request.getContextPath()%>/" method="post">
			<table border="0" class="style4">
				<tr>
					<th width="150"> 작성자 </th>
					<td width="500"> <input type="text" name="writer" size=80 value="${m.writer }" readonly></td>
				</tr>
				<tr>
					<th width="150"> 제목 </th>
					<td width="500"> <input type="text" name="title" size=80 value="${m.title }"></td>
				</tr>
				<tr>
					<th width="150"> 글 비밀번호 </th>
					<td width="500"> <input type="password" name="pwd" size=80 value="${m.pwd }"></td>
				</tr>
				<tr>
					<th width="150"> 내용 </th>
